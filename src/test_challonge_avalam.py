...
async def fonction() :
    t = ChallongeTournament(id_challonge="Seahorse_Corail", keypass_challonge="WG8g6kBT5AYvaonSi7Ae0pWeKFZgXaHXMZhIDOR6", game_name="challonge_avalam", log_file="log.txt")
