...
if __name__ == "__main__":
    ...
    asyncio.run(e.run_multiple_rounds(rounds=40, nb_process=10, swap=True, folder_players="seahorse.examples.tictactoe.", name_player1="random_player_tictac", name_player2="random_player_2_tictac", port=8080))
